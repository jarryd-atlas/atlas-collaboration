...
const CK_NAV: NavItem[] = [
  ...
  { label: "Customers", href: "/customers", icon: <Building2 className="h-5 w-5" />, matchPrefix: "/customers" },
...
function getCustomerNav(customerSlug: string): NavItem[] {
  ...
  return [
    { label: "Home", href: base, icon: <LayoutDashboard className="h-5 w-5" /> },
    { label: "Sites", href: `${base}/sites`, icon: <MapPin className="h-5 w-5" />, matchPrefix: `${base}/sites` },
    { label: "Milestones", href: `${base}/milestones`, icon: <ListTodo className="h-5 w-5" />, matchPrefix: `${base}/milestones` },
    ...
    <aside className="flex h-screen w-64 flex-col border-r border-gray-100 bg-white">
      ...
      {!isInternal && activeCustomerSlug && (
        <div className="px-6 py-3 border-b border-gray-100 bg-gray-50">
          <p className="text-xs font-medium text-gray-400 uppercase tracking-wider">Customer Portal</p>
